...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws-networking"></a> [aws-networking](#module\_aws-networking) | ./modules/networking | n/a |
...
|------|-------------|------|---------|:--------:|
| <a name="input_allocated_storage"></a> [allocated\_storage](#input\_allocated\_storage) | maximum strorage size | `number` | `null` | no |
...
| <a name="input_ami"></a> [ami](#input\_ami) | The ID of the AMI to use for the EC2 instance | `string` | `"ami-0d7a109bf30624c99"` | no |
...
| <a name="input_key_name"></a> [key\_name](#input\_key\_name) | n/a | `string` | `"tf-key"` | no |
...
| <a name="input_name"></a> [name](#input\_name) | n/a | `string` | `"webserver"` | no |
| <a name="input_parameter_group_name"></a> [parameter\_group\_name](#input\_parameter\_group\_name) | n/a | `string` | n/a | yes |
| <a name="input_private_cidrs"></a> [private\_cidrs](#input\_private\_cidrs) | n/a | `list(string)` | <pre>[<br>  "10.0.3.0/24",<br>  "10.0.4.0/24"<br>]</pre> | no |
| <a name="input_public_cidrs"></a> [public\_cidrs](#input\_public\_cidrs) | n/a | `list(string)` | <pre>[<br>  "10.0.1.0/24",<br>  "10.0.2.0/24"<br>]</pre> | no |
